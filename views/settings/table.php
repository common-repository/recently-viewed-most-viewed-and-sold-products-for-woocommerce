...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'recently-viewed-products-for-woocommerce' ),
		'products'			=> __( 'Products', 'recently-viewed-products-for-woocommerce' ),
		'order_total'		=> __( 'Order Total', 'recently-viewed-products-for-woocommerce' ),
		'commission'		=> __( 'Commission', 'recently-viewed-products-for-woocommerce' ),
		'payment_status'	=> __( 'Payment Status', 'recently-viewed-products-for-woocommerce' ),
		'time'				=> __( 'Time', 'recently-viewed-products-for-woocommerce' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'recently-viewed-products-for-woocommerce' ),
		'draft'		=> __( 'Draft', 'recently-viewed-products-for-woocommerce' ),
	],
];
